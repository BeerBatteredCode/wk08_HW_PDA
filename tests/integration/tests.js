...
describe('calculator functionality', function() {
  ...
  it('should check operations update the display with the result of the operation', function(){
    running_total = element(by.css('#running_total'))
    element(by.css('#number4')).click();
  ...
  it('should output negative numbers as expected', function(){
    running_total = element(by.css('#running_total'))
  ...
  it('should output decimal numbers as expected', function(){
    running_total = element(by.css('#running_total'))
    element(by.css('#number1')).click();
  ...
  it('should output very large numbers as expected', function(){
    running_total = element(by.css('#running_total'))
    element(by.css('#number1')).click();
